...
export const ContactElement = ({ contacts, borrarContacto, id }) => {
    ...
    const { stomport React, { useContext } from "react";
imre, actions } = useContext(Context);
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            Oh no, me elimines! podemos seguir siendo amigos?
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Oh nou</button>
                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => borrarContacto(id)}>SIUUU!</button>
                        </div>
                    </div>
                </div>
            </div>
