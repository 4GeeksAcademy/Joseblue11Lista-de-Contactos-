    ...
    <div className="container contenedor-form">
      ...
      <div className="contenedor-form d-flex flex-column">
        ...
        <input
          ...
          className="mb-3"
          value={dataContacto.address}
          onChange={manejarInputs}
          required
        />
      </div>
      <div className="contenedor-submit">
        <button onClick={manejarBotonSave}>Guardar</button>
      </div>
